...
class SolutionsDetailsPage extends StatelessWidget {
  final logic = Get.find<SolutionsDetailsLogic>();

  SolutionsDetailsPage({Key? key}) : super(key: key);
    ...
    return SingleChildScrollView(
      ...
      child: Column(
        ...
        children: [
          ...
          Padding(
            ...
            child: Row(
              ...
              children: [
                ...
                IconButton(
                    onPressed: logic.updaSolution, icon: const Icon(Icons.edit))
              ],
            ),
          ),
          ...
          Padding(
            padding: const EdgeInsets.symmetric(horizontal: 20),
            child: GetBuilder<SolutionsDetailsLogic>(
              id: 'solution',
              builder: (_) {
